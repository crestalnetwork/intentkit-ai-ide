  ...
  return (
    <footer className="bg-[#161b22] border-t border-[#30363d] py-1">
      <div className="max-w-full mx-auto px-2 sm:px-4 flex flex-col sm:flex-row justify-between items-center space-y-1 sm:space-y-0">
        ...
        {showConnectionStatus && baseUrl && (
          <div className="flex items-center space-x-1 sm:space-x-2 text-xs text-[#d0ff16] order-1 sm:order-2">
            <div className="w-1 h-1 sm:w-1.5 sm:h-1.5 sm:w-2 sm:h-2 bg-[#d0ff16] rounded-full animate-pulse"></div>
            <span className="truncate max-w-32 sm:max-w-48 sm:max-w-none text-xs">
